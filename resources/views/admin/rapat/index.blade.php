        ...
        <table class=" table-bordered">
            <thead>
                <tr>
                    ...
                    <th scope="col">FGD 1</th>
                    <th scope="col">FGD 2</th>
                    <th scope="col">FGD 3</th>
                ...
                @forelse($rapats as $rapat)
                    ...
                    <tr>
                        ...
                        <td>
                            @if($rapat->fgd1)
                                <a class="text-decoration:none text-dark" target="blank"
                                    href="{{ asset('storage/' .$rapat->fgd1) }}">ADA</a>
                            @else
                                <p> Tidak Ada</p>
                            @endif
                        </td>
                        <td>
                            @if($rapat->fgd2)
                                <a class="text-decoration:none text-dark" target="blank"
                                    href="{{ asset('storage/' .$rapat->fgd2) }}">ADA</a>
                            @else
                                <p> Tidak Ada</p>
                            @endif
                        </td>
                        <td>
                            @if($rapat->fgd3)
                                <a class="text-decoration:none text-dark" target="blank"
                                    href="{{ asset('storage/' .$rapat->fgd3) }}">ADA</a>
                            @else
                                <p> Tidak Ada</p>
                            @endif
                        </td>
                        <td>
                            <div class="d-flex">
                                {{-- Trigger modal --}}
                                <a href="{{ route('rapat.edit', $rapat->id) }}"><i
                                        class="text-black d-block"><svg width="33" height="33" viewBox="0 0 33 33"
                            ...
                            <button type="button" class="border-0" data-bs-toggle="modal" data-bs-target="#deleteUserModal_{{$rapat->id}}">
                                ...
                                <form  method="POST"
                                    action="{{ route('rapat.destroy',$rapat->id) }}">
                                    @csrf
                                    @method('delete')
                                        <div class="modal fade" id="deleteUserModal_{{$rapat->id}}" tabindex="-1" role="dialog"
