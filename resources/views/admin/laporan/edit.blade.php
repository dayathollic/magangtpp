                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form action="{{ route('laporan.update', $laporan->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                <label>SAMPUL</label>
                                <input type="hidden" name="oldSampul" value="{{ $laporan->sampul }}">
                                <input type="file"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="abstrak" value="{{ old('abstrak',$laporan->abstrak) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="nama_paket_pekerjaan" value="{{ old('nama_paket_pekerjaan',$laporan->nama_paket_pekerjaan) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tahun') is-invalid @enderror"
                                    name="tahun" value="{{ old('tahun',$laporan->tahun) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="instansi_pekerjaan" value="{{ old('instansi_pekerjaan',$laporan->instansi_pekerjaan) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('rak_dokumen') is-invalid @enderror"
                                    name="rak_dokumen" value="{{ old('rak_dokumen',$laporan->rak_dokumen) }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldLaporanPendahuluan" value="{{ $laporan->laporan_pendahuluan }}">
                                <input type="file"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldLaporanAntara" value="{{ $laporan->laporan_antara }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldLaporanAkhir" value="{{ $laporan->laporan_akhir }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldPolicyBrief" value="{{ $laporan->policy_brief }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldNaskahAkademik" value="{{ $laporan->naskah_akademik }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldRancanganLaporan" value="{{ $laporan->rancangan_laporan }}">
                                <input type="file"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldProdukLainnya" value="{{ $laporan->produk_lainnya }}">
