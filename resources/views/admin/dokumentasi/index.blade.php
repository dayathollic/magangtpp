...
<div class="content-wrapper">
    <table class="table table-borderless">
        <thead>
            <tr>
                <th colspan="6"><a href="{{ route('dokumentasi.create') }}"><button type="button"
                            class="btn text-white" style="background-color: #49EA11">+ Tambah
                            Data</button></a>
                </th>
                
                <th rowspan="6" class="d-flex justify-content-end">
                    <form action="{{ url('/admin/dokumentasi') }}" method="GET">
    ...
    {{-- <section class="content-header"> --}}
        ...
        <div class="container-fluid text-center">
            <div class="row">
                <table class="table-responsive-lg table-sm table-bordered">
                    <thead>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($dokumentasi->presensi)
                                        <a class="text-decoration:none text-dark" target="blank"
                                            href="{{ asset('storage/' .$dokumentasi->presensi) }}">ADA</a>
                                    @else
                                        <p> Tidak Ada</p>
                                    @endif
                                </td>
                                <td>
                                    @if($dokumentasi->notulensi)
                                        <a class="text-decoration:none text-dark" target="blank"
                                            href="{{ asset('storage/' .$dokumentasi->notulensi) }}">ADA</a>
                                    @else
                                        <p> Tidak Ada</p>
                                    @endif
                                </td>
                                <td>
                                    @if($dokumentasi->foto_dan_video)
                                        <a href="{{ $dokumentasi->foto_dan_video }}"
                                            class="text-decoration:none text-dark" target="blank">ADA</a>
                                    @else
                                        <p> Tidak Ada</p>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        {{-- Trigger modal --}}
                                        <a
                                            href="{{ route('dokumentasi.edit', $dokumentasi->id) }}"><i
                                            ...
                                            <button type="button" class="border-0" data-bs-toggle="modal" data-bs-target="#deleteUserModal_{{$dokumentasi->id}}">
                                                ...
                                                <form  method="POST"
                                                    action="{{ route('dokumentasi.destroy',$dokumentasi->id) }}">
                                                    @csrf
                                                    @method('delete')
                                                        <div class="modal fade" id="deleteUserModal_{{$dokumentasi->id}}" tabindex="-1" role="dialog"
