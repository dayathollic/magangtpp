                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('dokumentasi.update', $dokumentasi->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldPresensi" value="{{ $dokumentasi->presensi }}">
                                <input type="file"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldDokumentasi" value="{{ $dokumentasi->notulensi }}">
                                <input type="file"
                                    class="form-control @error('notulensi') is-invalid @enderror"
                                    name="notulensi">
                            ...
                            <div class="mb-2">
                                ...
                                {{-- <input type="hidden"  > --}}
                                <input type="link" value="{{ $dokumentasi->foto_dan_video }}" class="form-control @error('foto_dan_video') is-invalid @enderror"
                                    name="foto_dan_video">
