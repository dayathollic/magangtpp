        ...
        <div class="content-wrapper">
            ...
            <!-- Content Header (Page header) -->
                <div class="container-fluid text-center">
                    <div class="row">
                        <table class="table-responsive-lg table-bordered" id="myTable">
                            <thead>
                                <tr>
                                    <th scope="col">Kode</th>
                                    <th scope="col">Nama Paket Pekerjaan</th>
                                    <th scope="col">Sumber Data</th>
                                    <th scope="col">Data Sekunder</th>
                                    <th scope="col">Data Primer</th>
                                    <th scope="col">Pengolahan Data</th>
                                    <th scope="col">Daftar Pertanyaan</th>
                                    <th scope="col">Kriteria Responden</th>
                                    <th scope="col">Hasil Survey</th>
                                    <th scope="col">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($datanyas as $data)
                                @csrf
                                <tr>
                                    <td>{{ $data->no }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$data->sumber_data) }}">ADA</a>
                                        @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank"
                                            href="{{asset('storage/' .$data->data_sekunder) }}">ADA</a>
                                        @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        @if ($data->data_primer)
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$data->data_primer)  }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$data->pengolahan_data)  }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$data->daftar_pertanyaan)  }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank"
                                            href="{{ asset('storage/' .$data->kriteria_responden) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$data->hasil_survey) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                        {{-- Trigger modal --}}
                                            <a href="{{ route('data.edit', $data->id) }}"><i
                                                ...
                                                <button type="button" class="border-0" data-bs-toggle="modal" data-bs-target="#deleteUserModal_{{$data->id}}">
                                                    ...
                                                    <form  method="POST"
                                                        action="{{ route('data.destroy',$data->id) }}">
                                                        @csrf
                                                        @method('delete')
                                                            <div class="modal fade" id="deleteUserModal_{{$data->id}}" tabindex="-1" role="dialog"
