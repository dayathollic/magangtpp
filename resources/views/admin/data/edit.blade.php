                        ...
                        <form action="{{ route('data.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="nama_paket_pekerjaan" value="{{ old('nama_paket_pekerjaan',$data->nama_paket_pekerjaan) }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldSumberData" value="{{ $data->sumber_data }}">
                                <input type="file"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldDataSekunder" value="{{ $data->data_sekunder }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldaDataPrimer" value="{{ $data->data_primer }}">
                                <input type="file" class="form-control @error('data_primer') is-invalid @enderror"
                                    name="data_primer">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldPengolahanData" value="{{ $data->pengolahan_data }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldDaftarPertanyaan" value="{{ $data->daftar_pertanyaan }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldKriteriaResponden" value="{{ $data->kriteria_responden }}">
                                <input type="file"
                                    class="form-control @error('kriteria_responden') is-invalid @enderror"
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="oldHasilResponden" value="{{ $data->hasil_responden }}">
