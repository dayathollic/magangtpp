    ...
    <!-- Right navbar links -->
        ...
        <div class="content-wrapper">
            <table class="table table-borderless">
                <thead>
                    <tr>
                        <th colspan="6"><a href="{{ route('dokumenlelang.create') }}"><button type="button"
                                    class="btn text-white" style="background-color: #49EA11">+ Tambah
                                    Data</button></a>
                        </th>
                        
                        <th rowspan="6" class="d-flex justify-content-end">
                            <form action="{{ url('/admin/dokumenlelang') }}" method="GET">
                        ...
                        <table class="table-responsive table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Data Perusahaan</th>
                                    <th scope="col">Pengalaman Perusahaan</th>
                                    <th scope="col">Uraian Pengalaman Perusahaan</th>
                                    <th scope="col">Ustek</th>
                                    <th scope="col">Metodologi Dan Program Kerja</th>
                                    <th scope="col">Jadwal Pekerjaan</th>
                                    <th scope="col">Tenaga Ahli</th>
                                    <th scope="col">Komposisi Penugasan</th>
                                    <th scope="col">Jadwal Penugasan Ta</th>
                                    <th scope="col">Rab Penawaran</th>
                                    <th scope="col">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($dokumenlelangs as $dokumenlelang)
                                @csrf
                                <tr>
                                    <td>{{ $dokumenlelang->kode }}</td>
                                    <td>{{ $dokumenlelang->nama_paket_pekerjaan }}</td>
                                    <td>{{ $dokumenlelang->rak_dokumen }}</td>
                                    <td>
                                        @if ($dokumenlelang->data_perusahaan)
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->data_perusahaan) }}">ADA</a>
                                        @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank"
                                            href="{{asset('storage/' .$dokumenlelang->pengalaman_perusahaan) }}">ADA</a>
                                        @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->uraian_pengalaman_perusahaan)  }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->ustek)  }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank"
                                            href="{{ asset('storage/' .$dokumenlelang->metodologi_dan_program_kerja) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->jadwal_pekerjaan) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->tanaga_ahli) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->komposisi_penugasan) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        @if ($dokumenlelang->jadwal_penugasaan_ta)
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->jadwal_penugasaan_ta) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <a class="text-decoration:none text-dark" target="blank" 
                                            href="{{ asset('storage/' .$dokumenlelang->rab_penawaran) }}">ADA</a>
                                            @else
                                        <p> Tidak Ada</p>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                        {{-- Trigger modal --}}
                                            <a href="{{ route('dokumenlelang.edit', $dokumenlelang->id) }}"><i
                                                ...
                                                <button type="button" class="border-0" data-bs-toggle="modal" data-bs-target="#deleteUserModal_{{$dokumenlelang->id}}">
                                                    ...
                                                    <form  method="POST"
                                                        action="{{ route('dokumenlelang.destroy',$dokumenlelang->id) }}">
                                                        @csrf
                                                        @method('delete')
                                                            <div class="modal fade" id="deleteUserModal_{{$dokumenlelang->id}}" tabindex="-1" role="dialog"
