    ...
    <!-- Right navbar links -->
        ...
        <div class="content-wrapper">
            <table class="table table-borderless">
                <thead>
                    <tr>
                        <th colspan="6"><a href="{{ route('usermanagement.create') }}"><button type="button"
                                    class="btn text-white" style="background-color: #49EA11">+ Tambah
                                    Data</button></a>
                        </th>
                        
                        <th rowspan="6" class="d-flex justify-content-end">
                            <form action="{{ url('/admin/usermanagement') }}" method="GET">
            ...
            <!-- Content Header (Page header) -->
                <div class="container-fluid text-center">
                    <div class="row">
                        <table class="table-responsive-xxl table-bordered">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                        {{-- Trigger modal --}}
                                            <a href="{{ route('usermanagement.edit', $usermanagement->id) }}">
                                                <i
                                                ...
                                                <button type="button" class="border-0" data-bs-toggle="modal" data-bs-target="#deleteUserModal_{{$usermanagement->id}}">
                                                    ...
                                                    <form  method="POST"
                                                        ...
                                                        @csrf
                                                        @method('delete')
                                                            <div class="modal fade" id="deleteUserModal_{{$usermanagement->id}}" tabindex="-1" role="dialog"
